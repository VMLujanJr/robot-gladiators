...
var fightOrSkip = function() {
  ...
  /* ***** You could also write the same conditional statement (falsy values) like the following... ***** */
  if (!promptFight) {
  ...
  if (promptFight === "skip") {
    ...
    if (confirmSkip) {
      ...
      //subtract money from playMoney for skipping but don't let them go in the negative
...
var startGame = function() {
  ...
  for (var i = 0; i < enemyInfo.length; i++) {
    ...
    if (playerInfo.health > 0) {
      ...
      // pick new enemy to fight based on the index of the enemyInfo.name array
...
var playerInfo = {
  ...
  } // no comma! unless you add more methods!
};
